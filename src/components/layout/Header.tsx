...
export function Header() {
  ...
  return (
    <header className="h-14 border-b border-border bg-surface/60 backdrop-blur px-6 flex items-center justify-between">
      <div>
        <div className="text-[15px] font-semibold tracking-tight">Gen AI Portfolio Advisor</div>
        <div className="text-[11px] text-muted-foreground font-mono">
          {analysis ? `${analysis.market} · ${analysis.benchmarkName}` : "No portfolio loaded"}
        </div>
      </div>
